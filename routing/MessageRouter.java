...
public abstract class MessageRouter {
	...
	/** Setting value for Hop based queue mode */
	public static final int Q_MODE_HOP = 3;
	...
	public MessageRouter(Settings s) {
		...
		if(s.getInt("advFlag") == 1){
			sendQueueMode = 3;
			System.out.println("Advanced Mode On!\n");
		}
		...
		case Q_MODE_HOP:
			Collections.sort(list, 
				...
				public int compare(Object o1, Object o2) {
					...
					diff = m1.getHopCount() - m2.getHopCount();
					if (diff == 0) {
						return 0;
					}
					return (diff < 0 ? -1 : 1);
